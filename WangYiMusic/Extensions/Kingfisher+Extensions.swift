...
//    func setImageAspectFillScale(with resource: Resource?, placeholder: UIImage? = WY_PLACEHOLDER_IMAGE) {
//        if let placeholder = placeholder {
//            self.base.image = placeholder
//        }
//        guard let resource = resource else {return}
//        KingfisherManager.shared.retrieveImage(with: resource, options: nil, progressBlock: nil, completionHandler: { (imageParam, error, cacheType, url) in
